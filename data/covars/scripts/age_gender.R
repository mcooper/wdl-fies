...
age_gender <- read.csv('data/covars/results/age_gender_31missing.csv')
length(setdiff(unique(fies_raw$ISO3), unique(age_gender$iso_code))) #we are missing 31/77 countries, shit!!
setdiff(unique(fies_raw$ISO3), unique(age_gender$iso_code))

...
dat <- read.csv('data/covars_nowcast/rawdata/imports/API_NE.IMP.GNFS.CD_DS2_en_csv_v2_1120983.csv', skip=4) %>%
...
write.csv(dat, 'data/covars_nowcast/results/imports_percap.csv', row.names=F)

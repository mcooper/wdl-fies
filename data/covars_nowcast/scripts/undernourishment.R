...
dat <- read.csv('data/covars_nowcast/rawdata/undernourishment/API_SN.ITK.DEFC.ZS_DS2_en_csv_v2_1120870.csv', skip=4) %>%
...
#write.csv(dat, 'data/covars_nowcast/results/undernourishment.csv', row.names=F)

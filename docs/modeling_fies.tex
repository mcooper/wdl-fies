...
- tried different modelling approaches: lasso, bayes ssvs and random forest

- random forest performed best in terms of r2/mse and predictions

- random forest used because it captures interactions, machine learning approach

- tuned hyperparameters based on OOB error rate for different combinations, mtry and nodesize

- estimated 5000 trees

- awesome in-sample fit, overfitting?

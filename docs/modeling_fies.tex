...
%once implemented add here more to disaggregation 
...
%NOTE: WHEN JUSTIFYING COVARIATES, SAY THAT WE USE MANY FROM DEVELOPING COUNTRIES BECAUSE THE CAUSES OF FOOD INSECURITY ARE MORE DIVERSE THERE: ALMOST A KARENINA PRINCIPLE

%update/create this table once we have our final model
\begin{table}[H]
	\begin{tabular}{llll}
		\toprule
...
%in general we use middle of the road but maybe also other scenarios to account for uncertainty

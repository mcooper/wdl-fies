...
modified: 2021-07-08T14:25:54-0400
...
**To add more clarity, we have changed the phrasing in most places from "subnational" to "administrative area", as this might improve some of the confusion around the spatial scale of our analysis.  The Gallup data is a purposive sample designed to be representative at the national level, and we dissaggregated it based on demographic characteristics to the administrative area level.  Gallup records whether individual respondents are in urban or rural areas based on the individuals own reporting.  We then use global gridded data that is available under various SSPs to estimate the percent of the population in urban areas for each administrative area.  We tried to cover this in the _Disaggregation_ subsection of the _Methods_ section, and have endeavoured to make this section even more clear and explicit.**
